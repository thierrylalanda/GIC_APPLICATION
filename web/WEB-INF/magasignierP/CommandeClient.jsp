    ...
    <div class="widget-body">
        <div class="bs-docs-example">
            ...
            <div class="row-fluid">
                ...
                <a href="Commande_All_Client?vue=Commande Personnel&action=saveClient&niveau=3"data-toggle="tooltip" title='Enregistrer Votre Commande' >  <button type="submit" class="btn btn-lg btn-large btn-success"><i class="icon-save"></i> Enregistrer</button></a>
