    ...
    <div class="widget-body">
        <div class="bs-docs-example">
            ...
            <div class="row-fluid responsive ">    
                <form method="post" action="Commande_All_Client?vue=Commande Interne&action=ajouter&niveau=5" class="form-inline" id="commandeClit">
            ...
            <div class="row-fluid">
                ...
                <a href="Commande_All_Client?vue=Commande Interne&action=saveClient&niveau=5"data-toggle="tooltip" title='Enregistrer Votre Commande' >  <button type="submit" class="btn btn-lg btn-large btn-success"><i class="icon-save"></i> Enregistrer</button></a>
            </div>
