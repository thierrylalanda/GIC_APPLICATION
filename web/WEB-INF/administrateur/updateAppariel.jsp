...
<ul class="breadcrumb">
    ...
    <li class="active">
        <a href="admin?vue=Appariels&action=goHome"><i class="icon-desktop"></i> Appariels</a>
        <span class="divider">/</span>
    </li>
    <li class="active">
    ...
    <div class="widget ">
        ...
        <div class="widget-body ">
            ...
            <form class="form-horizontal" method="POST" action="SettingPersonnal?vue=Appariels&action=EditAppariel">
                ...
                <div class="control-group form-group row-fluid" >
                    <div style="margin-left: 10px">
                        <div class="control-group form-group span4">
                            ...
                            <input type="text" class="form-control input-lg" required value="${apparielSelect.getNumeroParck()}" name="numeroParck" />

                        </div>
                        <div class="control-group form-group span4">
                            <label class="control-label">Numero Serie</label>

                            <input type="text" class=" input-lg form-control" required name="numeroSerie" value="${apparielSelect.getNumeroSerie()}">
                ...
                <div class="control-group form-group row-fluid"> </div>
                ...
                <div class="row-border">
                    ...
                    <div class="control-group row-fluid ">
                        <button type="submit"  class="btn btn-success btn-large btn-block btn-lg" value="${apparielSelect.getNumeroParck()}" name="numeroParck">Mettre A Jour</button>
