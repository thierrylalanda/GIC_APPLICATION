            ...
            <div class="tab-pane" id="tabsleft-tab1">
                ...
                <div class="row-fluid">
                    ...
                    <div class="control-group form-group span4">
                        ...
                        <div class="controls ">
                            <select name="type_categorie" multiple="multiple" id="articlesCateories" required class="form-control input-lg">
                    ...
                    <div class="control-group form-group ">
                        ...
                        <div class="controls ">
                            <input type="text" class=" input-lg form-control span6" name="nom_magasin" required >
                        </div>
                    </div>
                </div>
