...
<div class="widget orange">
    <div class="widget-title">
        <h4><i class="icon-reorder"></i> Magasin Principal</h4>
        <span class="tools">
        ...
        <div class="bs-docs-example">
            <ul class="nav nav-tabs" id="myTab">
                <c:if test="${not empty sessionScope.lien30  or sessionScope.GeneralAdministrateur == 'OK'}">
                    <li class="<c:if test="${empty transf and empty form}">active</c:if>"><a data-toggle="tab" href="#home">Tous Les Magasins Principaux</a></li>
                    </c:if>
                        ...
                        <form method="POST" action="parametre?action=tranfertCategorieMP&vue=createMagP" >
                            <div class="row-fluid">
                                <div class="control-group form-group span4">
                                    ...
                                    <div class="controls ">
                                        <select name="magasin1" id="magasinexpediteurMp" required class="form-control input-lg" >
                                            <option></option>
                            ...
                            <div class="control-group form-group span4">
                                ...
                                <div class="controls ">
                                    <select name="magasin2" id="site_service" required class="form-control input-lg" >
                                        <option></option>
                                        <c:forEach items="${MagasinsP}" var="mags">
                                            <option value="${mags.getIdMagasin()}">
                                                ${mags.getNomMagasin()}
                                ...
                                <table style="width: 100%;" class="">
                                    <tr>
                                        ...
                                        <td style="width: 35%">
                                            ...
                                            <div class="d-sel-filter">
                                                <h4><strong>nouvelles Categories Magasin Recepteur</strong></h4>
                            ...
                            <div class="row-fluid">
                                <button type="submit" class="btn btn-success span12">valider</button>
                            </div>
                        </div>
                    </form>
                                    ...
                                    <div  class="tab-content">
                                        <div class="row-fluid">
                                            ...
                                            <div class="control-group span4">
                                                ...
                                                <div class="controls ">
                                                    <select name="region_site" id="" required class="form-control input-lg region_site" >
                                            ...
                                            <div class="control-group form-group span4">
                                                <label class="control-label">Categories Produits : ${magasin.getNomMagasin()}</label>
                                                <div class="controls ">
                                                    <div class="row-fluid">
                                                        <div class="span3">
                                                            <a class="btn btn-primary addcategoriebtnMP" href="" name="${magasin.getIdMagasin()}" data-toggle="modal" data-target="" >ajouter</a><br>

                                                        </div>

                                                        <div class="span3">
                                                            <a class="btn btn-primary deletecategoriebtnMP" href="" name="${magasin.getIdMagasin()}" data-toggle="modal" data-target="" >suprimer</a><br>

                                                        </div>

                                                        <div class="span3">
                                                            <a class="btn btn-primary deletearticlebtnMP" href="" name="${magasin.getIdMagasin()}" data-toggle="modal" data-target="" >suprimer un article</a><br>

                                                        </div>
                                                    </div>
                                                    <div class="space20"></div>
                                                    <select name="type_categorie" id="example-getting-starte" class="form-control input-lg">
                                            ...
                                            <div class="control-group form-group ">
                                                ...
                                                <div class="controls ">
                                                    <input type="text" value="${magasin.getNomMagasin()}" class=" input-lg form-control span6" name="nom_magasin" required >
                                                </div>
                                            </div>
                                        </div>
