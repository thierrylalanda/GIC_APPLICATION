...
<div class="widget black">
    <div class="widget-title">
        <h4><i class="icon-reorder"></i> Etat General De consommation: ${magasin.getNomMagasin()}</h4>
        <span class="tools">
                ...
                <div class="space12 ">
                    ...
                    <form method="post" action="listeproduit?vue=Historique MS&action=date&niveau=4&id_magasin=${magasin.getIdMagasin()}&etat=ok" class="form-inline">
                        ...
                        <div class=" span3 ">
                            ...
                            <button type="submit" class="btn btn-success  btn-primary pull-left btn-lg btn-large" id="sendcc" >Search</button>

                        </div>
                    </form>
                    <form class="form-inline "method="post" action="listeproduit?vue=Historique MS&action=rien&niveau=4&id_magasin=${magasin.getIdMagasin()}&etat=ok">
