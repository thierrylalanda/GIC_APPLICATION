...
$(document).ready(function () {
    ...
    function Simple_impression(data) {
        ...
        var bordereau = '<div class="bordereau" style="padding:2px;margin-bottom:5px">' +
                '<span class="titre_bordereau" style="text-align:center">' +
                'BORDEREAU D\' EXPEDITION CHEZ UN MAGASIN SECONDAIRE ' +
                '</span><br>' +
                '<span class="date_validation" style="text-align:center">validé le ' + $("td.date:first").text() + ' par LALANDA</span>' +
                '<p><strong>Date expedition: </strong>  ' + new Date().getDate() + '/' + (new Date().getMonth() + 1) + '/' + new Date().getFullYear() +
                '<span class="second"><strong  style="">MAGASIN: </strong>  FESCAO' +
                '</span></p>' +
                '<p><strong>Nom expediteur: </strong>  HENRILALANDA' +
                '<span class=" second_r"> <strong  style="">Nom responsable: </strong>  LALANDA' +
                '</span></p>' +
                '<p><strong>Region: </strong>  CENTRE' +
                '<span class=" second_s"> <strong  style="">Site: </strong> CCY2' +
                '</span></p>' +
                '<p><strong>Libellé expedition: </strong>  EXP_SBIMP4357' +
                '</p>' +
                '<p><span class="second">personnel</span>' +
                ' <span class=" second">Magasignier</span></p><br><br><br>' +
        ...
        var bordereau2 = '<div class="bordereau" style="padding:2px;margin-bottom:5px">' +
                ...
                '</p>' +
                '<p><strong>Region: </strong>  ' + $(".region_user").text() +
                '</p>' +
            ...
            buttons: [
                ...
                'pageLength',
                {
                    ...
                    customize: function (win) {
                        ...
                        $(win.document.body).find('.titre_bordereau').css({'text-align': 'center', 'margin-left': "200px"});
